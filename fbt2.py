                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
							...
							if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
								pilih = ['iya saya','ada apa ka?','kangen ya?','tag mulu','duhh kena tag','gift tikel dong ka']
                            ...
                            if text.lower() == 'me':
                                ...
                                try:
                                    ...
                                    for i in range(len(st)):
                                        ...
                                        channel.comment(str(sender), str(result), 'Auto Like by PRO')
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['eh ada','hai kak','ketauan deh','gabung yok kak','aloo..','nah','lg ngapain','halo','kok ngintip ka','sini kak']
